//! The pseudo-terminal itself, on the platforms that have one: opening the
//! pair, sizing it, giving the session a controlling terminal, and the two
//! directions of reading and writing it. See [`super`] for what it is all for.
